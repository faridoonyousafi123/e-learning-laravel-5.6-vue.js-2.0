                                                    ...
                                                    <td style="word-wrap:break-word;font-size:0px;padding:0px;" align="left">
                                                      <div style="cursor:auto;color:#5d7079;font-family:TW-Averta-Regular, Averta, Helvetica, Arial;font-size:16px;line-height:24px;letter-spacing:0.4px;text-align:left;"> <p></p>
                                                        ...
                                                        <p>
                                                          ...
                                                          <form action="{{ route('request.submit', ['id' => $user->id]) }}" method="post">

                                                            {{csrf_field()}}
                                                              <button class="btn" type="submit" mc:disable-tracking="">
                                                             Submit Request
                                                           </button> 
                                                       ...
                                                       <p class="hero">We have recieved your request and it's under process.</p>
                                                        <p>Our Team will send you an email once your request is approved.
                                                        </p>
                                                        <p>
                                                       ...
                                                       <p>If you don’t know why you got this email, please contact us at support@afghanyouthdev.com straight away so we can
                                                       fix this for you.</p>
